...
#define TEAM_NO 10    //insert your team number here
...
int zgt_tm::BeginTx(long tid, int thrNum, char type)
 {
   ...
   nodeinfo->obno = -1;
   nodeinfo->count= SEQNUM[tid]=0; //Each operation is assigned its position using the count variable before a thread is created.
   int status;
